                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 underline">REGISTRATION</a>
                        @endif
                    @endauth
                </div>
            @endif
...
<h1 style="color:orange;"> Welcome to Login Registration page </h1>
<h2 style="color:red;"> BY - BADAL KUMAR</h2>
